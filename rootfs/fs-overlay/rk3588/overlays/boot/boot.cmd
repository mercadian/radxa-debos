...
for overlay_file in ${overlays}; do
	if load ${devtype} ${devnum} ${load_addr} ${prefix}dtbs/${kernelversion}/rockchip/overlay/${overlay_file}.dtbo; then
...
if test "${overlay_error}" = "true"; then
	...
	if load ${devtype} ${devnum} ${load_addr} ${prefix}dtbs/${kernelversion}/rockchip/overlay/${overlay_prefix}-fixup.scr; then
